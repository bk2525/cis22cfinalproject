...
public class LinkedList<T> {
   ...
   /**
    ...
    /**
     * Moves all nodes in the list towards the end of the list the number of times specified.
     * Any node that falls off the end of the list as it moves forward will be placed at the front of the list.
     * 
     ...
     * @postcondition iterator position unchanged (i.e. still referencing the same node in the list, regardless of new location of Node)
    ...
    /**
     * returns each element from the linkedlist in a string with its position (1-n), followed by new line
